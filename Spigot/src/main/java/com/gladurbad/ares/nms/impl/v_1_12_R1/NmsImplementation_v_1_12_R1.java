package com.gladurbad.ares.nms.impl.v_1_12_R1;
...
public class NmsImplementation_v_1_12_R1 implements NmsImplementation {
    @Override
    public Entity getEntityFromId(World world, int id) {
        CraftWorld craftWorld = (CraftWorld) world;
        net.minecraft.server.v1_12_R1.World nmsWorld = craftWorld.getHandle();
        net.minecraft.server.v1_12_R1.Entity nmsEntity = nmsWorld.getEntity(id);
    ...
    public float getSlipperiness(Location location) {
        ...
        net.minecraft.server.v1_12_R1.Block nmsBlock = MinecraftServer.getServer().getWorld().getType(blockPos).getBlock();
