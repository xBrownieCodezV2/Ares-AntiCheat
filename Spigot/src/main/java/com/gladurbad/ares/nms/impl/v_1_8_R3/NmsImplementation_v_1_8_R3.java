package com.gladurbad.ares.nms.impl.v_1_8_R3;
...
public class NmsImplementation_v_1_8_R3 implements NmsImplementation {
    @Override
    public Entity getEntityFromId(World world, int id) {
        CraftWorld craftWorld = (CraftWorld) world;
        net.minecraft.server.v1_8_R3.World nmsWorld = craftWorld.getHandle();
        net.minecraft.server.v1_8_R3.Entity nmsEntity = nmsWorld.a(id);
    ...
    public float getSlipperiness(Location location) {
        ...
        net.minecraft.server.v1_8_R3.Block nmsBlock = MinecraftServer.getServer().getWorld().getType(blockPos).getBlock();
